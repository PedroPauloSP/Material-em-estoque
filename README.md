...
Projeto: Sistema de Controle de Estoque de Material

Tecnologia: Java Web Spring MVC
...
Cadastro de equipamentos/materiais.
Registro de movimentações de entrada.
Registro de movimentações de saída.
Controle automático do estoque disponível.
Cálculo do valor total das movimentações.
Consulta e gerenciamento dos registros cadastrados.
